...
public:
	...
	DEFINE_MEMBER_FN_1(MountImage, bool, 0x0236FBE0, NiTexture **);
	DEFINE_MEMBER_FN_1(UnmountImage, bool, 0x0236FEF0, NiTexture **);
};
...
public:
	...
	DEFINE_MEMBER_FN(LoadMovie, bool, 0x0219A9A0, IMenu * menu, GFxMovieView *&, const char * name, const char * stagePath, UInt32 flags);
};
