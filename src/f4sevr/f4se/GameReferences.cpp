...
RelocPtr <PlayerCharacter*> g_player(0x05B043F0);
...
RelocPtr <UInt32> g_invalidRefHandle(0x0392E884);

RelocAddr <_HasDetectionLOS> HasDetectionLOS(0x013E0290);

RelocAddr <_GetLinkedRef_Native> GetLinkedRef_Native(0x0046A120);

RelocAddr <_SetLinkedRef_Native> SetLinkedRef_Native(0x0046A140);

RelocAddr <_MoveRefrToPosition> MoveRefrToPosition(0x01483930);
