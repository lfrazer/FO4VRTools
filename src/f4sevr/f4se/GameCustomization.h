...
public:
	...
	DEFINE_MEMBER_FN(LoadPreset, void, 0x00CF4200, UInt32 presetIndex); // Loads preset by index onto the actor
};
...
public:
	...
	DEFINE_MEMBER_FN(ApplyDynamicData, void, 0x00667000, BSTriShape * trishape);
};
